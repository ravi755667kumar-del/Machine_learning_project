...
# Allowed hosts set to accept all incoming connections
ALLOWED_HOSTS = ['*']
...
# IMPORTANT: Change 'my_django_project' to whatever the name of your main folder is!
...
# Allows your frontend UI to communicate with Django
